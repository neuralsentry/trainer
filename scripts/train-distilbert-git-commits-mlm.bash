...
model_name="distilbert-git-commits-mlm"
...
config_training_num_train_epochs=20
...
config_training_logging_steps=100
...
config_model_model_name_or_path="distilbert-base-uncased"
