...
model_name="distilbert-vulnfix-classification"
export WANDB_PROJECT="vulnfix-classification"
...
config_training_learning_rate=1e-5
...
config_training_eval_steps=200
config_training_logging_steps=200
config_training_save_steps=200
...
config_model_model_name_or_path="neuralsentry/distilbert-vulnfix-classification"
config_model_model_revision="main"
config_model_cache_dir=".cache"
config_data_dataset_name="neuralsentry/vulnfix-commits"
config_data_max_seq_length=256
config_data_validation_split_percentage=20
